...
class CafeForm(FlaskForm):
    ...
    coffee = SelectField('Coffee',choices=["☕️","☕️☕️","☕️☕️️☕️","☕️☕️☕️☕️","☕️☕☕️☕️☕️️"] ,validators=[DataRequired()])
    wifi =SelectField('Coffee',choices=["💪","💪💪","💪💪💪","💪💪💪💪","💪💪💪💪💪"] ,validators=[DataRequired()])
    power = SelectField('Coffee',choices=["️🔌","🔌🔌","🔌🔌🔌️","🔌🔌🔌🔌","🔌🔌🔌🔌🔌"] ,validators=[DataRequired()])
